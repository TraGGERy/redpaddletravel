...
interface AddCruiseFormProps {
  onSuccess: () => void;
  onCancel: () => void;
  credentials: string;
}

const AddCruiseForm: React.FC<AddCruiseFormProps> = ({ onSuccess, onCancel, credentials }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to add cruise ship');
      }
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white flex items-center">
            <FaShip className="mr-2" /> Add New Cruise Ship
          </h3>
          <button
            onClick={onCancel}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="departurePort" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Departure Port *
              </label>
              <input
                type="text"
            ...
            <div className="md:col-span-2">
              <label htmlFor="destinations" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Destinations *
              </label>
              <textarea
                id="destinations"
                ...
                required
                rows={3}
                placeholder="Mediterranean, Caribbean, Alaska, etc."
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            >
              {isSubmitting ? 'Adding...' : 'Add Cruise'}
            </button>
          </div>
        </form>
      </div>
